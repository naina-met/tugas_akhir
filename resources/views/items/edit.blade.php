<x-app-layout>
    ...
    <div class="min-h-screen bg-[#002147] py-10">
        <div class="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow border-2 border-[#002147]">
                <form method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text"
                                      name="name" value="{{ old('name', $item->name ?? '') }}" required autofocus />
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" name="description"
                                  class="block mt-1 w-full rounded-md shadow-sm border-gray-300">{{ old('description', $item->description ?? '') }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="stock" class="block mt-1 w-full" type="number"
                                      name="stock" value="{{ old('stock', $item->stock ?? 0) }}" required />
    ...
    <!-- Script to disable submit button on submit -->
    <script>
